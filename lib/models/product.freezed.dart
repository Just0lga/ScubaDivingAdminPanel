...
class _$ProductImpl implements _Product {
  ...
  @override
  String toString() {
    return 'Product(id: $id, name: $name, categoryId: $categoryId, brand: $brand, price: $price, discountPrice: $discountPrice, stock: $stock, description: $description, reviewCount: $reviewCount, features: $features, isActive: $isActive, favoriteCount: $favoriteCount, createdAt: $createdAt, updatedAt: $updatedAt, mainPictureUrl: $mainPictureUrl)';
  }
